...
public class TotalRevenueFileOutputTest {
    ...
    /**
     * Test of stateHasChanged method, of class TotalRevenueFileOutput.
     */
    @Test
    public void testStateHasChanged() {
        System.out.println("stateHasChanged");
        double totalRevenue = 0.0;
        TotalRevenueFileOutput instance = new TotalRevenueFileOutputImpl();
        instance.stateHasChanged(totalRevenue);
    }

    public class TotalRevenueFileOutputImpl extends TotalRevenueFileOutput {
    }
